...
class FirstAidActivity : AppCompatActivity() {
    ...
    lateinit var CoursetButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoursetButton.setOnClickListener {
            // create the explicit intent
